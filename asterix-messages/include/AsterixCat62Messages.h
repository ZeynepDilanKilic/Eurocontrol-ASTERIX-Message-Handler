#pragma once
#include "../categories-definitions/Cat62.h"
#include "../categories-types/Cat62Types.h"
...
public:
  ...
  bool encodeData(json &cat62_json_data, const char *data);

  void to_json(json &j);
  void from_json(AsterixMessage_Cat62 &);
